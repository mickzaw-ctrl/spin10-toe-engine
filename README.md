...
## IFT-EGR v0.2 stability and v0.3 closure research modules

The engine includes an isolated JAX/Equinox prototype for Information-Frequency Time and emergent graph gravity. Its local and Slurm validation establish numerical stability only; the proper-time, entropy-response, causal-GFT, and continuum-gravity mappings remain project hypotheses.

- Stabilized source: [`src/ift_egr.py`](src/ift_egr.py)
- Stability contract tests: [`tests/test_ift_egr.py`](tests/test_ift_egr.py)
- Scientific status and validation: [`docs/IFT_EGR_VALIDATION.md`](docs/IFT_EGR_VALIDATION.md)
- Cosmology closure gates: [`src/ift_egr_closure.py`](src/ift_egr_closure.py)
